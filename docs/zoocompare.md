...
1. Download **ZOOcompare** package from https://www.zoolanders.com/extensions/zoocompare.
...
4. Find the **ZOOcompare** Extension in the list and click on the Install button.
...
Locate and open the ZOOcompare Chart / Compare layout assignment view for the App and Type you have set up in the Step 1. For detailed information please review the [ZOO Positions Assignments](http://www.yootheme.com/zoo/documentation/advanced/assign-elements-to-layout-positions) and [Chart](#chart) docs.
...
Additionaly you could set up the ZOOcompare Module in order to list the user selected Items for comparison. Checkout it's docs for more details about it.
...
* Rows
  ...
  Additionally you can place the Compare Element in this position to render special rows such as Main Header and Header or even add custom ones. Checkout the [Element Doc](element-compare) for more details.
...
* Toolbar
  ...
  Checkout the [Element Doc](element-compare) for more details.
