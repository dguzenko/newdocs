...
This documentation offers help and guidance for ZOOlanders ZOOcart Extension. More information about it can be find on the ZOOlanders site, https://www.zoolanders.com/extensions/zoocart.
...
* Download **ZOOcart** package from https://www.zoolanders.com/extensions/zoocart.
* Install the previously unpacked App/s. If you are not familiar with this process please review the official ZOO docs.
* Go to the **Joomla Extension Manager** (Joomla Administration / Extensions / Extension Manager / Install).
...
* Unpack all files from the **ZOOcart** downloaded package to a directory on your pc.
* Using FTP, upload this directory to the /tmp directory of your Joomla installation on your webserver.
* Go to the **Joomla Extension Manager** (Joomla Administration / Extensions / Extension Manager / Install).
* Use the "Install from Directory" option to set the directory of your uploaded package files.
...
* Find the **ZOOcart** Extension in the list and click on the Install button.
...
And setup all the necessary params. Follow the **Configuration Wizard** messages - it will help you to complete the configuration. For more details please review the [Settings doc](#settings) .
