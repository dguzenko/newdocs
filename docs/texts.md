...
This documentation offers help and guidance for ZOOlanders **Texts** Extension. More information about it can be find on the [official page](https://www.zoolanders.com/extensions/texts).
...
4. Find the **Texts** Extension in the list and click on the Install button.
...
Add the *Textarea Pro* element to the desired Type and configure as needed. If you are not familiar with this process please review the [official ZOO docs](http://www.yootheme.com/zoo/documentation/advanced/extend-pre-build-types). For details about the element config options review the [Type Config section](#textarea-pro-params-in-detail-type-config).

### Position assignment

Assign the *Textarea Pro* element to the desired layout positions and configure as needed. If you are not familiar with this process please review the [official ZOO docs](http://www.yootheme.com/zoo/documentation/advanced/assign-elements-to-layout-positions). For details about the element assignment options review the [Assignment section](#textarea-pro-params-in-detail-position-assignment).
...
8. Open the Element options and [configure](#textarea-pro-configuration) it as needed.
9. Save the Type. Your entries should now be updated to use the *Textarea Pro* element.

Translation
-----------

The default **en-GB.plg_system_zoo_zlelements_textareapro.ini** language file is located in the **administrator/language/en-GB** folder and the translation should be placed into the language related folder replacing the **en-GB** part.
...
For more information about the Layouts please review the [Layouts section](#textarea-pro-params-in-detail-layouts).
...
Listed are the inbuild layouts of Textarea Pro element but if those don't meet your project requirements you can [create your own](#textarea-pro-customizations-layouts) ones.
...
Add the *Text Pro* element to the desired Type and configure as needed. If you are not familiar with this process please review the [official ZOO docs](http://www.yootheme.com/zoo/documentation/advanced/extend-pre-build-types). For details about the element config options review the [Type Config section](#text-pro-params-in-detail-type-config).

### Position assignment

Assign the *Text Pro* element to the desired layout positions and configure as needed. If you are not familiar with this process please review the [official ZOO docs](http://www.yootheme.com/zoo/documentation/advanced/assign-elements-to-layout-positions). For details about the element assignment options review the [Assignment section](#text-pro-params-in-detail-position-assignment).
...
5. Save the changes and return to your ZOO admin area.
6. Edit that same Type elements.
7. Locate and open the element that you are switching from. That element that was a *Text* lement before should now be *Text Pro* element.
8. Open the Element options and [configure](#text-pro-configuration) it as needed.
9. Save the Type. Your entries should now be updated to use the *Text Pro* element.

Translation
-----------

The default **en-GB.plg_system_zoo_zlelements_textpro.ini** language file is located in the **administrator/language/en-GB** folder and the translation should be placed into the language related folder replacing the **en-GB** part.

Eg: **administrator/language/YOUR-LANG/YOUR-LANG.plg_system_zoo_zlelements_textpro.ini**

The translations are managed by [Transifex](https://www.transifex.com/projects/p/zoolanders/) where you can download the available language files and submit your ones.

Text Pro Params in detail
================
...
For more information about the Layouts please review the [Layouts section](#text-pro-params-in-detail-layouts)
...
Listed are the inbuild layouts of Text Pro element but if those don't meet your project requirements you can [create your own](#text-pro-customizations-layouts) ones.
