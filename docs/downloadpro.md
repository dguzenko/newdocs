...
Unpack all files from the **Download Pro** downloaded package to a directory on your pc.
...
* **AWS AccessKey** - AWS access key. You can read more about it [herehere](http://docs.aws.amazon.com/fws/1.1/GettingStartedGuide/index.html?AWSCredentials.html).
...
Listed are the inbuild layouts of Download Pro element but if those don't meet your project requirements you can create your own ones.
