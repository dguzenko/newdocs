...
### Related Categories Pro 3.x requires
...
* Previously installed:
  ...
  * **ZOO 3.0.4** or higher
    ...
    You may download it from [YOOtheme site](https://www.zoolanders.com/extensions/zl-framework)
...
1. Download **Related Categories Pro** package from https://www.zoolanders.com/extensions/related-categories-pro.
...
1. Unpack all files from the **Related Categories Pro** downloaded package to a directory on your pc.
...
4. Find the **Related Categories Pro** Extension in the list and click on the Install button.
...
Switching from ZOO Related Categories to ZL Related Categories Pro
------------------------------------------------------------------
...
Listed are the inbuild layouts of Related Categories Pro element but if those don't meet your project requirements you can create your own ones.
